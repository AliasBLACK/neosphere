...
import { YGDirection, YGFlexDirection, YGPositionType, YGJustify, YGAlign, YGWrap, YGOverflow, YGDisplay, YGEdgeCount, YGUnit, } from './enums';
...
class YGStyle {
    constructor() {
        this.margin = new Array(YGEdgeCount);
        this.position = new Array(YGEdgeCount);
        this.padding = new Array(YGEdgeCount);
        this.border = new Array(YGEdgeCount);
...
export { YGStyle };
//# sourceMappingURL=../src/out/ygstyle.js.map